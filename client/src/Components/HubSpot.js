        ...
        <div id='projFlexContainerHS'>
            ...
            <div className='rows'>
                ...
                <div className='halfWidth pushImg'>
                    <img className='projectImg autoHeight' src={Impulse} alt="Project Screen Shot" />
                    <a className='projectLinks' href='https://impulsecreative.com/company'><h3 className='center'>Impulse Creative Full Stack Developer</h3><h5 className='center'>Developer for Impulse Creative</h5><h5 className='center' id='hubspotOrange'>HubSpot Websites, Themes & Templates. API Integrations, Custom Objects, HubDB, React & Custom UI Components, as well as other awesome CMS applications.</h5></a>
                </div>
